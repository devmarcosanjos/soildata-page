      ...
      >
        ...
        <div className="max-w-[1920px] mx-auto w-full px-4 md:px-6 lg:px-0">
          <div className="max-w-[1200px] mx-auto w-full px-2 md:px-4 lg:px-0">
            ...
            O repositório SoilData é a vitrine do trabalho de campo e laboratório de quem estuda o solo brasileiro! Nele, você pode publicar dados que tenha produzido em seus projetos. Você também pode encontrar dados para utilizar em suas atividades{' '}
            <span className="text-rotate">
              <span>
                <span>de ensino.</span>
                <span >de pesquisa.</span>
                <span>e inclusive comerciais.</span>
              </span>
            </span>
          </p>
          ...
          <p className="text-white text-sm md:text-base">
            Pesquise em centenas de conjuntos de dados sobre solos brasileiros
          </p>
          ...
          <div className="mt-6 flex justify-center -translate-y-2.5">
            <div className="inline-flex items-center gap-1 px-2 md:px-2.5 py-1 md:py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/40 shadow-lg">
              <p className="text-white text-[10px] md:text-xs font-medium drop-shadow-sm">
                Todos os conjuntos de dados contém
              </p>
              <img 
